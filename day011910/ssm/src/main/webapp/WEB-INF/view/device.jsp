...
<body class="gray-bg">
        ...
        <div class="row">
			  ...
			  <div class="col-lg-2">
				<div class="input-group">
					...
					<select class="form-control" name="status" id = "status01">
					...
					<form id="form_user" method="post" action="reserveDevice.htm">
						...
						<table style="border-collapse:separate; border-spacing:0px 10px;">
							...
							<tr>
								<td>设备类型：</td>
								<td colspan="2">
									<select class="form-control" name="dtype" id = "roleid" aria-required="true" required>
										<option value="">---请选择---</option>
	...
	function initEditUser(getSelection){
		...
		$('#roleid').val(getSelection.dtype);
		$('#username').val(getSelection.dname);
		$('#dram').val(getSelection.dram);
		$('#password').val(getSelection.price);
